...
import {
  WMTS_default
} from "./chunk-X7B7VAU4.js";
import "./chunk-YXKE4XM5.js";
import {
  Versions
} from "./chunk-I3C6DOPL.js";
import {
  Stamen_default
} from "./chunk-XP3EQTDW.js";
import {
  DataTile_default,
  ImageCanvas_default,
...
import {
  TileWMS_default
} from "./chunk-IJ7Z3MTF.js";
import {
  ImageWMS_default,
  Image_default as Image_default2,
  defaultImageLoadFunction
} from "./chunk-UW7NNMT3.js";
import {
  appendParams
} from "./chunk-3JLAXBDU.js";
import "./chunk-RE3PXSSL.js";
import {
  Feature_default
...
import "./chunk-UWNNKYBQ.js";
import {
  OSM_default
} from "./chunk-WDA3YYKA.js";
import {
  TileQueue_default
} from "./chunk-Z75ZFP6E.js";
import "./chunk-3EHMZQUM.js";
import "./chunk-II5LGZJQ.js";
  ...
  constructor(input, _byteOffset, _length) {
    ...
    if (isFloat16Array(input)) {
      ...
      if (isNativeTypedArray(input)) {
        ...
        const BufferConstructor = !isSharedArrayBuffer(buffer3) ? SpeciesConstructor(
          buffer3,
          NativeArrayBuffer
        ) : NativeArrayBuffer;
        if (IsDetachedBuffer(buffer3)) {
...
addDecoder([8, 32946], () => import("./deflate-EVOYY2HR.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-SPJW7VZE.js").then((m) => m.default));
addDecoder(34887, () => import("./lerc-EONGPPOL.js").then((m) => m.default));
...
var Processor = class extends Disposable_default {
  ...
  _resolveJob() {
    ...
    if (threads === 1) {
      ...
      const segmentLength = 4 * Math.ceil(length / 4 / threads);
      for (let i = 0; i < threads; ++i) {
        const buffer3 = this._dataLookup[i]["buffer"];
        const offset = i * segmentLength;
